...
var gameId="SVG026";
$(".carousel-thmbs a").click(function(t){t.preventDefault(),$(".carousel-thmbs a").removeClass("active"),$(this).addClass("active");var e=$(this).children("img").attr("data-img");$("#carousel-img img").attr("src",e)}),$(".carousel-thmbs a:first").click(),$.ajax({type:"GET",url:"http://dragonnest.nexon.net/api/game/server-status",dataType:"jsonp",crossDomain:!0,success:function(t){t.IsMaintenance&&$("#btnPlayNow").removeClass("spr-btn_play").addClass("spr-btn_offline").css({position:"relative",cursor:"default"}).unbind("click").click(function(t){t.preventDefault()})}}),$(window).resize(function(){window.RT&&clearTimeout(window.RT),window.RT=setTimeout(function(){this.location.reload(!1)},100)});var eleWidth,elePos,wWidth=$(window).innerWidth(),wHeight=$(window).innerHeight();$("body").css({width:wWidth+"px"});var eleWidth=2e3,elePosL=1050>wWidth?-475:.5*(wWidth-eleWidth);$("#heroBanner, #bg_videoBgWrapper").css({width:wWidth-elePosL+"px",left:elePosL+"px"});var elePosL=.5*(wWidth-1050)+17;$("#rc2-title").css({left:elePosL+"px"});var elePosL=1050>wWidth?-4e3:.5*(wWidth-1050)-4e3;$("#fog1").attr("data-0","left: "+elePosL+"px;").attr("data-200","left: "+(elePosL+2e3)+"px;").attr("data-350","left: "+(elePosL+3200)+"px;").attr("data-14000","left: "+(elePosL+4e3)+"px;").attr("data-15000","left: "+(elePosL+6e3)+"px;");var elePosL=1050>wWidth?4e3:.5*(wWidth-1050)+4e3;$("#fog2").attr("data-0","left: "+elePosL+"px;").attr("data-200","left: "+(elePosL-2e3)+"px;").attr("data-350","left: "+(elePosL-3200)+"px;").attr("data-14000","left: "+(elePosL-4e3)+"px;").attr("data-15000","left: "+(elePosL-6e3)+"px;");var elePosL=1050>wWidth?20:.5*(wWidth-1050)+20;$("#event1").attr("data-2500","left: "+elePosL+"px; opacity: 0;").attr("data-3000","left: "+(elePosL+45)+"px; opacity: 1;"),$("#event2").attr("data-5000","left: "+elePosL+"px; opacity: 0;").attr("data-5500","left: "+(elePosL+45)+"px; opacity: 1;"),$("#event3").attr("data-7500","left: "+elePosL+"px; opacity: 0;").attr("data-8000","left: "+(elePosL+45)+"px; opacity: 1;"),$("#event4").attr("data-10000","left: "+elePosL+"px; opacity: 0;").attr("data-10500","left: "+(elePosL+45)+"px; opacity: 1;"),$("#event5").attr("data-12500","left: "+elePosL+"px; opacity: 0;").attr("data-13000","left: "+(elePosL+45)+"px; opacity: 1;");var elePosL=1050>wWidth?75:.5*(wWidth-1050)+75;$("#details").attr("data-5000","top: 570px; left: "+elePosL+"px; opacity: 0;").attr("data-6000","opacity: 1;").attr("data-13800","").attr("data-14000","top: 475px; left: "+elePosL+"px; opacity: 0;");var elePosL=1050>wWidth?580:.5*(wWidth-1050)+580,elePosT=wHeight-908;$("#hero").css({left:elePosL}).attr("data-1500","top: "+elePosT+"px");var elePosL=1050>wWidth?-153:.5*(wWidth-1050)*-1;$("#monster").attr("data-1000","top: 250px; left: "+(elePosL-100)+"px; opacity: 0;").attr("data-2000","left: "+(elePosL-75)+"px; opacity: 1;").attr("data-14000","top: 100px; left: "+(elePosL+50)+"px").attr("data-14150","top: -25px; left: "+(elePosL+20)+"px; opacity: 0;");var elePosL=1050>wWidth?485:.5*(wWidth-1050)+485;$("#moon").css({left:elePosL});var elePosL=1050>wWidth?-510:.5*(wWidth-1050)-510;$("#rat").attr("data-13500","top: 1000px; left: "+elePosL+"px; opacity: 0;").attr("data-14500","opacity: 1;").attr("data-15400","top: -250px;");var eleWidth=561,leftPos=$("#boss").offset().left+561;if(leftPos>wWidth){var nWidth=eleWidth-(leftPos-wWidth);$("#boss").width(nWidth)}var eleWidth=2e3,elePosL=1050>wWidth?-475:.5*(wWidth-eleWidth);$("#monsters").css({width:wWidth-elePosL+"px",left:elePosL+"px"}),skrollr.init({smoothScrolling:!0,easing:"swing",scale:1}),function(t){t.cookie=function(t,e,a){if("undefined"==typeof e){var o=null;if(document.cookie&&""!=document.cookie)for(var i=document.cookie.split(";"),l=0;l<i.length;l++){var s=jQuery.trim(i[l]);if(s.substring(0,t.length+1)==t+"="){o=decodeURIComponent(s.substring(t.length+1));break}}return o}a=a||{},null===e&&(e="",a.expires=-1);var r="";if(a.expires&&("number"==typeof a.expires||a.expires.toUTCString)){var n;"number"==typeof a.expires?(n=new Date,n.setTime(n.getTime()+24*a.expires*60*60*1e3)):n=a.expires,r="; expires="+n.toUTCString()}var d=a.path?"; path="+a.path:"",p=a.domain?"; domain="+a.domain:"",c=a.secure?"; secure":"";document.cookie=[t,"=","true"==a.unescape?e:encodeURIComponent(e),r,d,p,c].join("")}}(jQuery),$(document).ready(function(){$.cookie("dragonnestLevel70Event","true",{expires:365,path:"/",domain:"nexon.net"})});var intervalCount=0,intervalID=window.setInterval(function(){$(".scroll").animate({marginTop:"40px"},1e3,function(){$(this).animate({marginTop:"0px"},1e3)}),intervalCount++,5==intervalCount&&clearInterval(intervalID)},2100),nice=$("html").getNiceScroll().hide();